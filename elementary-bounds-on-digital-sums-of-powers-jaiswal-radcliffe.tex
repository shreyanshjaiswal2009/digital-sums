...
\begin{proof}
	...
	Therefore, $\displaystyle t > p^{C_1 \log n}$, which implies that
	\[
		\log t > C_1 n \log p.
	\]
...
\begin{proof}
	...
	We apply Baker's theorem to the linear form in \eqref{def:Lambda}
	to obtain a lower bound on $|\Lambda|$. This will imply an upper bound
	on the gap $m_{i+1}/m_i$, as shown in \eqref{ineq:gap-bound} below.
